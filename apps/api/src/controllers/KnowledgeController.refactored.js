...
class KnowledgeController {
  ...
  async getKnowledgeBases(req, res) {
    try {
      const result = await this.knowledgeService.getUserKnowledgeBases(req.user)
  ...
  async createKnowledgeBase(req, res) {
    try {
      const data = {
        ...
        owner_department_id: req.body.owner_department_id || req.user.department_id,
  ...
  async getDocuments(req, res) {
    try {
      ...
      const result = await this.knowledgeService.getDocuments(kbId, req.query)
